...
class UmengPushAPI {
    ...
    function __construct(){
        $this->appkey = '56455c0f67e58e2f100042e2';
        $this->appMasterSecret = '8nog76i6nxtky4afjwptyknulcixcj3v';
    ...
    function setMasterSecret($masterSecret){
    ...
    //单播
	function sendAndroidUnicast($deviceToken,$ticker,$title,$text) {
		try {
			...
			$unicast->setPredefinedKeyValue("ticker",           $ticker);//提示文本
