...
define('APPKEY','ac4mtA8nMZAUQwvaleliY3');
define('APPID','OXxZAsAoxg5UF8VT7GEMg');
define('MASTERSECRET','4TnJOE16Ru7712cY7sek1A');
define('CID','98d6b88c67dbc5aa08a41335134b3e2c');
define('DEVICETOKEN','');
define('Alias','请输入别名');
...
//获取通知模板
function getIGtNotificationTemplate($title,$text,$logo){
