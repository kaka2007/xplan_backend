<?php
$options = array(
    'client_id'  => 'YXA6zOQxoEyAEeWJs5OjVUur7g',   //你的信息
    'client_secret' => 'YXA63rRzrvgElyfAR2uGrEouPUf0-x0',//你的信息
    'org_name' => 'plan' ,//你的信息
    'app_name' => 'plan' ,//你的信息
);
...
class Easemob
{
    ...
    */
    ...
    //批量注册用户
    public function registerManyUser($data){
        return $this->request('users',$data);
    }

    //删除单个用户
    public  function deleteUser(){
        return $this->request('users',NULL,'DELETE');
    }
